...
FloatValue          := FloatJustFrac | FloatJustExp | FloatBoth
FloatJustFrac       := IntegerPart FractionalPart
FloatJustExp        := IntegerPart ExponentPart
FloatBoth           := IntegerPart FractionalPart ExponentPart
